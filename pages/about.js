    ...
    <div className="row align-items-center">
      <div className="col-lg-4 col-md-6">
        <div className="service-item style-3 text-center">
          <div className="service-img">
            <img className="img-fluid" src={`${asset_img}about/biogx_albama_location.webp`} alt=""/>
          </div>
      ...
      <div className="col-lg-4 col-md-6 mt-5 mt-md-0">
        <div className="service-item style-3 text-center active">
          <div className="service-img">
            <img className="img-fluid" src={`${asset_img}about/biogx_texas_location.webp`} alt=""/>
          </div>
          <div className="service-desc pt-3 white-bg shadow-none">
      ...
      <div className="col-lg-4 col-md-6 mt-5 mt-lg-0">
        <div className="service-item style-3 text-center">
          <div className="service-img">
            <img className="img-fluid" src={`${asset_img}about/biogx_amsterdam_location.webp`} alt=""/>
          </div>
          <div className="service-desc pt-3 white-bg shadow-none">
    ...
    <div className="row">
          ...
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/shazi-bio.jpg`} alt=""/>
      ...
      <div className="col-lg-4  col-md-6  mb-5">
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/michael-bio.jpg`} alt=""/>
                <div className="service-icon" style={{background:"transparent"}}> 
                </div>
              </div>
              <div className="service-desc white-bg mt-n5 pt-7">
      ...
      <div className="col-lg-4  col-md-6  mb-5">
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/Richard1.webp`} alt=""/>
                <div className="service-icon" style={{background:"transparent"}}> 
                </div>
              </div>
              <div className="service-desc white-bg mt-n5 pt-7">
      ...
      <div className="col-lg-4  col-md-6  mb-5">
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/shahin-bio.jpg`} alt=""/>
                <div className="service-icon" style={{background:"transparent"}}> 
                </div>
              </div>
              <div className="service-desc white-bg mt-n5 pt-7">
      ...
      <div className="col-lg-4  col-md-6  mb-5">
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/george-bio.jpg`} alt=""/>
                <div className="service-icon" style={{background:"transparent"}}> 
                </div>
              </div>
              <div className="service-desc white-bg mt-n5 pt-7">
      ...
      <div className="col-lg-4  col-md-6  mb-5">
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/robert-bio.jpg`} alt=""/>
                <div className="service-icon" style={{background:"transparent"}}> 
                </div>
              </div>
              <div className="service-desc white-bg mt-n5 pt-7">
      ...
      <div className="col-lg-4  col-md-6  mb-5">
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/mohammed-bio.jpg`} alt=""/>
                <div className="service-icon" style={{background:"transparent"}}> 
                </div>
              </div>
              <div className="service-desc white-bg mt-n5 pt-7">
      ...
      <div className="col-lg-4  col-md-6  mb-5">
          <div className="item">
            <div className="service-item style-1">
              <div className="service-img mx-4 z-index-1 overflow-hidden">
                <img className="img-fluid" src={`${asset_img}about/Brent-Headshot-PNG.webp`} alt=""/>
                <div className="service-icon" style={{background:"transparent"}}> 
                </div>
              </div>
              <div className="service-desc white-bg mt-n5 pt-7">
      ...
      <div class="col-lg-6">
        ...
        <div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src={`${asset_img}about/biogx_team1.jpg`} alt=""/>
               
            </div>
          </div>
          <div class="item">
            <div class="cases-item position-relative overflow-hidden">
              <img class="img-fluid w-100" src={`${asset_img}about/biogx_team2.jpg`} alt=""/>
...
<section className="p-0">
  <div className="container-fluid p-0">
    <div className="row">
      <div className="col">
        <div className="p-md-8 p-4 text-center parallaxie" style={{  backgroundImage: `url(`+asset_img+'about/biogx_covidbg.jpg'+`)`  }} data-bg-img={`${asset_img}about/biogx_covidbg.jpg`} data-overlay="4">
